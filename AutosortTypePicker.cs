...
namespace AutosortLockers
{
    public class AutosortTypePicker : MonoBehaviour
    {
        ...
        public void Initialize(AutosortTarget locker)
        {
            ...
            background.sprite = ImageUtilsCommon.LoadSprite(Plugin.GetAssetPath("Background.png"));
        ...
        private static PickerPageButton AddPageButton(Transform parent, AutosortTypePicker target, int pageOffset, int x, int y)
        {
            ...
            pageButton.sprite = ImageUtilsCommon.LoadSprite(Plugin.GetAssetPath(pageOffset < 0 ? "ArrowLeft.png" : "ArrowRight.png"));
        ...
        private static Image CreateUnderline(Transform parent, int x)
        {
            ...
            underline.sprite = ImageUtilsCommon.LoadSprite(Plugin.GetAssetPath("TitleUnderline.png"));
        ...
        public static PickerCloseButton AddCloseButton(Transform parent)
        {
            ...
            closeImage.sprite = ImageUtilsCommon.LoadSprite(Plugin.GetAssetPath("Close.png"));
