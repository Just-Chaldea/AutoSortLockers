...
namespace AutosortLockers
{
    class Picker : MonoBehaviour
    {
        ...
        public virtual void Initialize()
        {
            ...
            {
                background.sprite = ImageUtilsCommon.Load9SliceSprite(Plugin.GetAssetPath("PickerBackground.png"), new RectOffset(100, 100, 100, 100));
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////
        protected static void Create(Transform parent, Picker instance, TextMeshProUGUI textPrefab, int buttonCount)
        {
            float padding = 30;
